...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/yourusername/web-crawler.git](https://github.com/yourusername/web-crawler.git)
   cd web-crawler
...
Bash
python app.py
The server will start on http://127.0.0.1:5000 and automatically initialize the crawler.db database.
...
JSON
{
  ...
  "recent_jobs": [
    {
      "id": 1,
      "origin_url": "[http://books.toscrape.com/](http://books.toscrape.com/)",
      "max_depth": 2,
      "status": "running",
      "pages_crawled": 145,
      "queue_size": 32
